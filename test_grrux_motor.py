"""Tests de `grrux_motor.py` — Fase GUI, Etapa G0.
...
Ejecutar:
    python -m pytest test_grrux_motor.py
    python test_grrux_motor.py
"""
...
def test_estado_antes_de_cargar():
    ...
    # solo por importar/testear grrux_motor.
    #
