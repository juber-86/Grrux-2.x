...
El código conserva nombres históricos como `grrux_server.py`; el nombre del
sistema es **GRRux**.
...
Para desarrollar sobre GRRux, ver [`docs/DESARROLLO.md`](docs/DESARROLLO.md)
(convenciones, pruebas, servidor local).
...
```text
grrux_ai1.py                         entrada de terminal
grrux_server.py → grrux_motor.py → gui/   GUI web local
