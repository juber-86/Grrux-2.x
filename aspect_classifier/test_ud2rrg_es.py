...
hace gruxx") y hacen aserciones ESTRUCTURALES sobre el árbol en memoria
...
def test_gold_ancora_crudo_convierte_igual_que_limpiado():
    ...
    # depender de gruxx_ai1/Stanza en un test rápido)
    limpio_txt = []
...
# ---------------------------------------------------------------------------
# L4 — checker de completeness end-to-end (gruxx_ai1 + completeness), solo
# con --slow / RUN_SLOW=1.
# ---------------------------------------------------------------------------
