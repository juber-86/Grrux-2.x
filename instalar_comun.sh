...
for archivo in grrux_server.py grrux_motor.py grrux_ai1.py rrg_ls_mapper.py ud2rrg.py requirements.txt; do
...
echo "[GRRux] GUI:      ./grrux-gui"
echo "[GRRux] terminal: ${VENV}/bin/python grrux_ai1.py"
